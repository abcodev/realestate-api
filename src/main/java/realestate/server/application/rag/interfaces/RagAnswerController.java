...
import realestate.server.application.rag.application.RagAnswerResponse;
...
public class RagAnswerController {
    ...
    public ApiResponse<RagAnswerResponse> ask(@RequestBody RagAskRequest request) {
        return ApiResponse.success(answerService.answer(request.query(), request.topK()));
    }
}
