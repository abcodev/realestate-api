...
import realestate.server.application.realestate.domain.AptPblancRepository;
import realestate.server.application.realestate.infrastructure.jpa.entity.AptPblancJpaEntity;
import realestate.server.application.realestate.infrastructure.jpa.mapper.AptPblancMapper;
import realestate.server.application.realestate.infrastructure.jpa.repository.AptPblancJpaRepository;
