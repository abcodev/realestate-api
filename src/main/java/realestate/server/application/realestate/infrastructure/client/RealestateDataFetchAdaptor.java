...
import realestate.server.application.realestate.domain.DataFetchPort;
...
public class RealestateDataFetchAdaptor implements DataFetchPort {
    ...
    public List<Deals> fetchDeals(String lawdCd, String dealYmd) {
        ...
        while (true) {
            realestate.server.application.realestate.infrastructure.client.dto.DealsApiResponse response = apiClient
