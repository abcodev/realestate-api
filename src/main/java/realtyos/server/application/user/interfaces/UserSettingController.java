package realtyos.server.application.user.interfaces;
...
import realtyos.server.application.user.application.UserSettingService;
import realtyos.server.application.user.interfaces.dto.LocationConsentSettingReqDto;
import realtyos.server.application.user.interfaces.dto.PushNotificationSettingReqDto;
