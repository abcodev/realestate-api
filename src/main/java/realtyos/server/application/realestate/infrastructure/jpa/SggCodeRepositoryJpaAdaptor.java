...
import realtyos.server.application.realestate.infrastructure.jpa.mapper.SggCodeMapper;
import realtyos.server.application.realestate.infrastructure.jpa.repository.SggCodeJpaRepository;
